	...
	return (
		<div className="sc-gap-6 font-onest sc-text-5 flex flex-col">
			...
			<p>
				...
				в громоздкие формулы. Вместо этого 
				<strong>
					мы на пальцах, простых примерах и понятных схемах объясним
				</strong>
				, как именно работает та математика, которая нужна, чтобы нейросети
				могли учиться и решать самые разные задачи.
			</p>
